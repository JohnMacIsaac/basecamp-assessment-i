...
// let me = `My name is ${myName} and my favorite number is ${faveNum}.` // rejected by test 
...
let trueFaveNum = faveNum === 3.14159;
...
let greeter = function greeter (name, number) {
  //return `Hi! I am ${myName} and I am 35 years old` // test rejected
